...
namespace Sim80C51.Toolbox.Wpf
{
    ...
    public class TwoColumnGrid : Panel
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            double newWidth = Math.Max(0, constraint.Width - col1Width - ColumnSpacing);
            Size newConstraint = new(newWidth, constraint.Height);
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            for (int i = 0; i < VisualChildrenCount; i++)
            {
                ...
                {
                    // Left child
                    Rect r = new(0, y, Column1Width, height);
                    child.Arrange(r);
                }
                else
                {
                    // Right child
                    Rect r = new(Column1Width + ColumnSpacing, y, arrangeSize.Width - Column1Width - ColumnSpacing, height);
                    child.Arrange(r);
                    y += height;
                    y += RowSpacing;
                }
